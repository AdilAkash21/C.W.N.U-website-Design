...
const campusMapUrl = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3426.37533225976!2d106.066285076085!3d30.82014758140181!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x36f29735ee1dcfd3%3A0x6152939c109ac2ec!2sChina%20West%20Normal%20University!5e0!3m2!1sen!2shk!4v1788287063148!5m2!1sen!2shk';
const campusDirectionsUrl = 'https://www.google.com/maps/search/?api=1&query=China+West+Normal+University%2C+Nanchong%2C+Sichuan%2C+China';
            ...
            <div>
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card border border-gray-100 dark:border-gray-800 p-8 h-full">
                ...
                <div className="mt-8 overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between gap-3 bg-gray-50 px-4 py-3 dark:bg-gray-800">
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Campus location</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Shunqing District, Nanchong</p>
                    </div>
                    <a
                      href={campusDirectionsUrl}
                      target="_blank"
                      rel="noreferrer"
                      className="whitespace-nowrap text-xs font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-400"
                    >
                      Get directions
                    </a>
                  </div>
                  <div className="relative h-56 w-full overflow-hidden bg-[#dce8d5] dark:bg-gray-700 sm:h-64">
                    <div
                      className="absolute inset-0 opacity-70"
                      aria-hidden="true"
                      style={{
                        backgroundImage:
                          'linear-gradient(28deg, transparent 46%, rgba(255,255,255,.9) 47%, rgba(255,255,255,.9) 49%, transparent 50%), linear-gradient(118deg, transparent 48%, rgba(255,255,255,.75) 49%, rgba(255,255,255,.75) 51%, transparent 52%), linear-gradient(90deg, rgba(171,197,161,.35) 1px, transparent 1px), linear-gradient(rgba(171,197,161,.35) 1px, transparent 1px)',
                        backgroundSize: '180px 120px, 220px 160px, 32px 32px, 32px 32px',
                      }}
                    />
                    <div className="absolute left-1/2 top-1/2 z-10 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center">
                      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-red-600 text-white shadow-lg ring-4 ring-white/80">
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path d="M12 2a7 7 0 00-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 00-7-7zm0 9.5A2.5 2.5 0 1112 6a2.5 2.5 0 010 5.5z" />
                        </svg>
                      </div>
                      <span className="mt-2 rounded-md bg-white/90 px-2 py-1 text-xs font-semibold text-gray-800 shadow">CWNU Campus</span>
                    </div>
                    <iframe
                      src={campusMapUrl}
                      title="Live map showing China West Normal University campus"
                      className="absolute inset-0 z-20 h-full w-full border-0 bg-transparent"
                      loading="lazy"
                      allowFullScreen
                      referrerPolicy="strict-origin-when-cross-origin"
                    />
                    <div className="pointer-events-none absolute inset-x-0 bottom-0 z-30 bg-gradient-to-t from-black/15 to-transparent p-3 text-right">
                      <span className="rounded bg-white/90 px-2 py-1 text-[11px] font-medium text-gray-700">Interactive map</span>
                    </div>
                  </div>
                </div>
              </div>
